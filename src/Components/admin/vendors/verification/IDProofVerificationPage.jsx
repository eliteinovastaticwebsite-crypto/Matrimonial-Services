          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                {['KYC ID', 'Vendor', 'Owner Name', 'ID Type', 'ID Number', 'Date of Birth', 'Photo Match', 'Status', 'Actions'].map(h => 
                ...
                filtered.map(k => (
                  <tr key={k.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <div className={`w-7 h-7 rounded-lg ${k.avatarBg} flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0`}>{k.vendor[0]}</div>
