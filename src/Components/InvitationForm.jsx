...
import { ArrowLeft, Gift, Package, Palette, Printer, FileText, Globe, Banknote, X, Pen, Trash2, Upload, Link as LinkIcon, Image as ImageIcon, DollarSign } from "lucide-react";
          ...
          <div className="max-w-full mx-auto">
            ...
            {step === 0 && (
              <div className="space-y-4">
                <h3 className="text-red-800 font-bold text-center text-xs sm:text-sm mb-3">
                  <Gift className="inline w-3 h-3 sm:w-4 sm:h-4 mr-2" />
                ...
                <div className="form-group">
                  <label className="form-label">Type of Services Provided *</label>
                ...
                <div className="form-group mt-4 pt-2 border-t border-red-200">
                  ...
                  <p className="text-[10px] sm:text-xs text-gray-500 mt-1">
                    Enter your typical price range for invitation and gift services
                  </p>
                </div>
              </div>
            )}
            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                <div className="form-group">
                  <label className="form-label">Office / Shop Address *</label>
                  <textarea 
                    name="address"
            ...
            {step === 3 && (
              <div className="space-y-4">
                ...
                <div className="form-group">
                  <label className="form-label">Invitation Types Offered *</label>
                  <div className="grid grid-cols-2 gap-2">
            ...
            {step === 4 && (
              <div className="space-y-4">
                ...
                <div className="form-group">
                  <label className="form-label">Types of Gifts Offered *</label>
                  <div className="grid grid-cols-2 gap-2">
                    {giftTypes.map(type => (
                      <label key={type} className="flex items-center gap-2 text-xs sm:text-sm">
                        <input 
                ...
                <div className="form-group">
                  <label className="form-label">Minimum Order Quantity for Gifts *</label>
                  <input 
                    name="giftMinOrder"
                    value={formData.giftMinOrder}
                    onChange={handleInputChange}
                    className="input-field" 
                    placeholder="Enter minimum order quantity for gifts" 
                    type="number"
                  />
                </div>
                
                <div className="form-group">
                  <label className="form-label">Branding / Name Printing Available *</label>
                  <div className="flex gap-4 text-xs sm:text-sm">
                    <label className="flex items-center gap-2">
                      <input 
                        type="radio" 
                ...
                <div className="form-group">
                  <label className="form-label">Packing & Wrapping Included *</label>
                  <div className="flex gap-4 text-xs sm:text-sm">
                    <label className="flex items-center gap-2">
                      <input 
                        type="radio" 
            ...
            {step === 5 && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="form-group">
                    <label className="form-label">Invitation Min Price (₹) *</label>
                    <input 
                  ...
                  <div className="form-group">
                    <label className="form-label">Invitation Max Price (₹) *</label>
                    <input 
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="form-group">
                    <label className="form-label">Gift Min Price (₹) *</label>
                    <input 
                      name="giftMinPrice"
                  ...
                  <div className="form-group">
                    <label className="form-label">Gift Max Price (₹) *</label>
                    <input 
                      name="giftMaxPrice"
                ...
                <div className="form-group">
                  ...
                  <input 
                    ...
                    onChange={handleInputChange}
                    className="input-field" 
                    placeholder="Enter balance payment terms" 
                  />
                </div>
              </div>
            )}
...
{step === 6 && (
  <div className="space-y-4">
    ...
    <div className="space-y-4">
      <div className="form-group">
        <label className="form-label">Design Approval (Days) *</label>
        <input 
          name="designApprovalTime"
          value={formData.designApprovalTime}
          onChange={handleInputChange}
          className="input-field" 
          placeholder="Enter number of days for design approval" 
          type="number"
          min="0"
        />
      </div>
      ...
      <div className="form-group">
        <label className="form-label">Printing & Delivery (Days) *</label>
        <input 
          name="printingDeliveryTime"
          value={formData.printingDeliveryTime}
          onChange={handleInputChange}
          className="input-field" 
          placeholder="Enter number of days for printing & delivery" 
          type="number"
          min="0"
        />
      </div>
      ...
      <div className="form-group">
        <label className="form-label">Gift Preparation (Days) *</label>
        <input 
          name="giftPreparationTime"
          value={formData.giftPreparationTime}
          onChange={handleInputChange}
          className="input-field" 
          placeholder="Enter number of days for gift preparation" 
          type="number"
          min="0"
        />
      </div>
            ...
            {step === 7 && (
              <div className="space-y-4">
                ...
                <div className="form-group">
                  <label className="form-label">Service Coverage Locations *</label>
                  <div className="grid grid-cols-2 gap-2">
                ...
                <div className="form-group">
                  ...
                  <div className="bg-white rounded-lg border border-red-200 p-2 sm:p-3 shadow-sm">
                    <textarea 
                      ...
                      placeholder="Describe your special offers, unique services, or any additional information about your invitation and gift services."
                    />
                  </div>
                </div>
