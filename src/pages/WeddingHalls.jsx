...
const WeddingHalls = () => {
  ...
  const weddingHallCategories = [
    { name: 'AC Wedding Halls', path: '/wedding-halls/ac-halls', image: achall },
    { name: 'Non AC Wedding Halls', path: '/wedding-halls/non-ac-halls', image: nonachall },
    { name: 'Luxury Wedding Halls', path: '/wedding-halls/luxury-halls', image: luxuryhall },
    { name: 'Mini Wedding Halls', path: '/wedding-halls/mini-halls', image: minihall },
    { name: 'Event Halls', path: '/wedding-halls/event-halls', image: eventhall },
    { name: 'Convention & Banquet Halls', path: '/wedding-halls/convention-halls', image: conventionhall },
    { name: 'Party & Reception Halls', path: '/wedding-halls/party-halls', image: partyhall },
    { name: 'Outdoor / Open-Air Venues', path: '/wedding-halls/outdoor-venues', image: outdoorvenue },
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:flex-1">
            {/* Wedding Hall Categories Grid - COMPACT SIZE */}
            ...
            <section className="py-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                  <div className="text-center md:text-left mb-4 md:mb-0">
                    <h3 className="text-2xl font-bold text-white">
                      {selectedEvent ? `${filteredVendors.length} ${selectedEvent} Vendors Available` : '16 Wedding Hall Vendors Available'}
                    </h3>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="bg-white/20 px-4 py-2 rounded-lg">
                      ...
                      <span className="text-yellow-300 ml-2">₹10,000 - ₹6,00,000 per event</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {filteredVendors.length > 0 ? (
                    ...
                    <div key={vendor.id} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                      <div className="flex flex-col md:flex-row">
                        ...
                        <div className="md:w-1/4 p-6">
                          <h4 className="font-bold text-red-700 mb-4 text-lg">Facilities Offered</h4>
                ...
                <div className="bg-white rounded-xl shadow-lg p-12 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-700 mb-2">No Wedding Halls Found</h3>
                  <p className="text-gray-600 mb-6">Try adjusting your filter criteria to find more venues</p>
                  <button 
                    onClick={handleReset}
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="sticky top-24 bg-white rounded-xl shadow-2xl border-2 border-red-200 p-6">
              ...
              {/* Budget Range */}
              <div className="mb-6">
                <label className="block text-sm font-bold text-gray-700 mb-2">Budget Range (₹ per event)</label>
              ...
              {/* Type of Hall */}
              <div className="mb-6">
                <label className="block text-sm font-bold text-gray-700 mb-2">Type of Hall</label>
                <select
                  value={selectedEvent}
