...
const WeddingHalls = () => {
  ...
  // Sample vendor data - 2 vendors for each hall type
  const vendors = [
    // AC Wedding Halls Vendors
    {
      ...
      services: ['Central AC', 'Stage Setup', 'Parking Space', 'Changing Rooms', 'Generator Backup'],
      logo: achall,
    ...
    },
    {
      ...
      services: ['Fully Air Conditioned', 'LED Lighting', 'Sound System', 'Kitchen Facilities', 'Decoration Support'],
      logo: achall,
    ...
    // Non AC Wedding Halls Vendors
    {
      ...
      description: 'Traditional non-AC hall with natural ventilation and garden setting',
      services: ['Natural Ventilation', 'Garden Area', 'Traditional Décor', 'Catering Space', 'Outdoor Seating'],
      logo: nonachall,
    ...
    },
    {
      ...
      services: ['Traditional Architecture', 'Large Capacity', 'Natural Lighting', 'Multiple Halls', 'Prayer Room'],
      logo: nonachall,
    ...
    // Luxury Wedding Halls Vendors
    {
      ...
      services: ['VIP Lounges', 'Premium Catering', 'Valet Parking', 'Bridal Suite', 'Professional Event Planning'],
      logo: luxuryhall,
      location: 'Chennai, Tamil Nadu',
      rating: 4.9,
    ...
    },
    {
      ...
      services: ['Custom Interiors', 'Premium Sound System', 'Luxury Décor', 'Private Garden', 'Concierge Service'],
      logo: luxuryhall,
    ...
    // Mini Wedding Halls Vendors
    {
      ...
      services: ['Intimate Setting', 'Personalized Service', 'Cost-Effective', 'Quick Setup', 'Home-like Feel'],
      logo: minihall,
    ...
    },
    {
      ...
      services: ['Family Gatherings', 'Simple Decorations', 'Basic Facilities', 'Affordable Packages', 'Flexible Timings'],
      logo: minihall,
    ...
    // Event Halls Vendors
    {
      ...
      services: ['Multi-Purpose Use', 'Flexible Layout', 'Modern Equipment', 'Catering Kitchen', 'Storage Space'],
      logo: eventhall,
    ...
    },
    {
      ...
      services: ['Central Location', 'Professional Staff', 'Technical Support', 'Catering Services', 'Parking Facility'],
      logo: eventhall,
    ...
    // Convention & Banquet Halls Vendors
    {
      ...
      services: ['Large Capacity', 'Multiple Halls', 'Professional Setup', 'Technical Support', 'Hospitality Services'],
      logo: conventionhall,
      location: 'Bangalore, Karnataka',
      rating: 4.7,
    ...
    },
    {
      ...
      services: ['Banquet Services', 'Event Planning', 'Catering Coordination', 'Decoration Services', 'Guest Management'],
      logo: conventionhall,
    ...
    // Party & Reception Halls Vendors
    {
      ...
      services: ['Reception Setup', 'Dance Floor', 'Party Lighting', 'DJ Booth', 'Bar Setup'],
      logo: partyhall,
      location: 'Chennai, Tamil Nadu',
      rating: 4.9,
    ...
    },
    {
      ...
      services: ['Themed Decorations', 'Sound & Lighting', 'Food Counters', 'Seating Arrangements', 'Entertainment Setup'],
      logo: partyhall,
    ...
    // Outdoor / Open-Air Venues Vendors
    {
      ...
      services: ['Garden Setting', 'Outdoor Seating', 'Natural Backdrop', 'Weather Contingency', 'Garden Decor'],
      logo: outdoorvenue,
      location: 'Chennai, Tamil Nadu',
      rating: 4.9,
    ...
    },
    {
      ...
      services: ['Panoramic Views', 'Natural Lighting', 'Outdoor Stage', 'Tent Setup', 'Landscaped Gardens'],
      logo: outdoorvenue,
      location: 'Coimbatore, Tamil Nadu',
      rating: 4.7,
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1 pr-2">
                      <h3 className="text-xs font-bold text-white leading-tight">
                        {selectedEvent ? `${filteredVendors.length} ${selectedEvent} Vendors` : '16 Wedding Hall Vendors'}
                      </h3>
                    ...
                    <div className="flex flex-col items-end">
                      <div className="bg-white/20 px-1.5 py-0.5 rounded mb-0.5">
                        ...
                        <span className="text-yellow-300 ml-0.5 text-[8px]">₹10,000 - ₹6,00,000</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-md shadow border border-red-200 p-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="col-span-2">
                      <label className="block text-[10px] font-bold text-gray-700 mb-0.5">Budget (₹ per event)</label>
                    ...
                    <div className="col-span-2">
                      <label className="block text-[10px] font-bold text-gray-700 mb-0.5">Hall Type</label>
                      <select
                        value={selectedEvent}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col items-end">
                      <div className="bg-white/20 px-2.5 py-1.5 rounded">
                        ...
                        <span className="text-yellow-300 ml-1.5 font-bold text-sm">₹10,000 - ₹6,00,000</span>
                      </div>
                    </div>
                  </div>
            ...
            <section className="py-1 md:py-2 vendor-profiles">
              {filteredVendors.length > 0 ? (
                          ...
                          <div className="md:hidden">
                            ...
                            <div className="flex border-b border-gray-200">
                              ...
                              <div className="w-1/2 p-2 bg-white">
                                <h4 className="font-bold text-red-700 mb-1 text-[10px]">Facilities Offered</h4>
                ...
                <div className="bg-white rounded-md shadow p-3 md:p-4 text-center">
                  ...
                  <h3 className="text-xs md:text-base font-bold text-gray-700 mb-0.5">No Wedding Halls Found</h3>
                  <p className="text-gray-600 mb-2 text-[10px] md:text-sm">Try adjusting your filter criteria to find more venues</p>
                  <button 
                    onClick={handleReset}
            ...
            <section className="py-2 md:py-4">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-1.5 md:gap-2">
                <div className="bg-white p-1.5 md:p-3 rounded-md shadow border border-red-100 hover:shadow-md transition-shadow duration-300">
                  ...
                  <h3 className="font-bold text-[9px] md:text-sm text-red-700 mb-0.5 md:mb-0.5 text-center">Prime Locations</h3>
                  <p className="text-gray-600 text-[8px] md:text-xs text-center leading-tight">Conveniently located venues with easy access</p>
                </div>
                ...
                <div className="bg-white p-1.5 md:p-3 rounded-md shadow border border-yellow-100 hover:shadow-md transition-shadow duration-300">
                  ...
                  <h3 className="font-bold text-[9px] md:text-sm text-red-700 mb-0.5 md:mb-0.5 text-center">Spacious Capacity</h3>
                  <p className="text-gray-600 text-[8px] md:text-xs text-center leading-tight">Accommodating halls for all guest sizes</p>
                </div>
                ...
                <div className="bg-white p-1.5 md:p-3 rounded-md shadow border border-red-100 hover:shadow-md transition-shadow duration-300">
                  ...
                  <h3 className="font-bold text-[9px] md:text-sm text-red-700 mb-0.5 md:mb-0.5 text-center">Modern Amenities</h3>
                  <p className="text-gray-600 text-[8px] md:text-xs text-center leading-tight">State-of-the-art facilities and equipment</p>
                </div>
                ...
                <div className="bg-white p-1.5 md:p-3 rounded-md shadow border border-yellow-100 hover:shadow-md transition-shadow duration-300">
                  ...
                  <h3 className="font-bold text-[9px] md:text-sm text-red-700 mb-0.5 md:mb-0.5 text-center">Flexible Packages</h3>
                  <p className="text-gray-600 text-[8px] md:text-xs text-center leading-tight">Customizable options to fit your budget</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <div id="filter-section" className="hidden lg:block lg:w-72 flex-shrink-0">
            ...
            <div className="sticky top-4 space-y-4 max-h-[calc(100vh-100px)] overflow-y-auto pr-1">
              ...
              <div className="bg-gradient-to-br from-red-50 to-yellow-50 rounded-lg shadow-lg border border-red-200 p-4">
                <div className="flex items-start mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs">
                      Use filters to find the perfect wedding hall for your special occasion
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-700">Select specific hall type</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-4 h-4 text-green-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-700">Find halls by state & district</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg border border-red-200 p-4">
                ...
                <div className="mb-3">
                  <label className="block text-xs font-bold text-gray-700 mb-1">Type of Hall</label>
                  <select
                    value={selectedEvent}
                    onChange={(e) => setSelectedEvent(e.target.value)}
        ...
        <div className="lg:hidden fixed inset-0 z-50 bg-black bg-opacity-50 flex items-end sm:items-center justify-center">
          <div className="bg-white w-full sm:max-w-md sm:mx-4 rounded-t-xl sm:rounded-lg shadow-2xl max-h-[80vh] overflow-y-auto">
            <div className="sticky top-0 bg-white z-10 p-3 border-b border-gray-200 flex justify-between items-center rounded-t-xl sm:rounded-t-lg">
              <h3 className="text-sm sm:text-base font-bold text-red-800">Filter Wedding Halls</h3>
              <button
