                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1 pr-2">
                      <h3 className="text-xs font-bold text-white leading-tight">
                        {selectedEvent ? `${filteredVendors.length} ${selectedEvent} Vendors` : '16 Decoration Vendors'}
                      </h3>
                    ...
                    <div className="flex flex-col items-end">
                      <div className="bg-white/20 px-1.5 py-0.5 rounded mb-0.5">
                        ...
                        <span className="text-yellow-300 ml-0.5 text-[8px]">₹15,000 - ₹6,00,000</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <section className="py-1 mb-2">
                <div className="bg-white rounded-md shadow border border-red-200 p-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="col-span-2">
                      <label className="block text-[10px] font-bold text-gray-700 mb-0.5">Decoration Type</label>
                      <select
                        value={selectedEvent}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col items-end">
                      <div className="bg-white/20 px-2.5 py-1.5 rounded">
                        ...
                        <span className="text-yellow-300 ml-1.5 font-bold text-sm">₹15,000 - ₹6,00,000</span>
                      </div>
                    </div>
                  </div>
            ...
            <section className="py-2 md:py-4">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-1.5 md:gap-2">
                <div className="bg-white p-1.5 md:p-3 rounded-md shadow border border-red-100 hover:shadow-md transition-shadow duration-300">
                  ...
                  <p className="text-gray-600 text-[8px] md:text-xs text-center leading-tight">Unique and innovative decoration concepts</p>
                </div>
                ...
                <div className="bg-white p-1.5 md:p-3 rounded-md shadow border border-yellow-100 hover:shadow-md transition-shadow duration-300">
                  ...
                  <h3 className="font-bold text-[9px] md:text-sm text-red-700 mb-0.5 md:mb-0.5 text-center">Timely Setup</h3>
                  <p className="text-gray-600 text-[8px] md:text-xs text-center leading-tight">Professional and punctual service delivery</p>
                </div>
                ...
                <div className="bg-white p-1.5 md:p-3 rounded-md shadow border border-red-100 hover:shadow-md transition-shadow duration-300">
                  ...
                  <h3 className="font-bold text-[9px] md:text-sm text-red-700 mb-0.5 md:mb-0.5 text-center">Expert Team</h3>
                  <p className="text-gray-600 text-[8px] md:text-xs text-center leading-tight">Experienced decorators and designers</p>
                </div>
                ...
                <div className="bg-white p-1.5 md:p-3 rounded-md shadow border border-yellow-100 hover:shadow-md transition-shadow duration-300">
                  ...
                  <p className="text-gray-600 text-[8px] md:text-xs text-center leading-tight">High-quality materials and craftsmanship</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <div id="filter-section" className="hidden lg:block lg:w-72 flex-shrink-0">
            ...
            <div className="sticky top-4 space-y-4 max-h-[calc(100vh-100px)] overflow-y-auto pr-1">
              ...
              <div className="bg-gradient-to-br from-red-50 to-yellow-50 rounded-lg shadow-lg border border-red-200 p-4">
                <div className="flex items-start mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs">
                      Use filters to find the perfect decoration vendor for your special occasion
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-700">Select specific decoration type</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-4 h-4 text-green-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div className="bg-white rounded-lg shadow-lg border border-red-200 p-4">
                ...
                <div className="mb-3">
                  <label className="block text-xs font-bold text-gray-700 mb-1">Type of Decoration</label>
                  <select
                    value={selectedEvent}
                    onChange={(e) => setSelectedEvent(e.target.value)}
        ...
        <div className="lg:hidden fixed inset-0 z-50 bg-black bg-opacity-50 flex items-end sm:items-center justify-center">
          <div className="bg-white w-full sm:max-w-md sm:mx-4 rounded-t-xl sm:rounded-lg shadow-2xl max-h-[80vh] overflow-y-auto">
            <div className="sticky top-0 bg-white z-10 p-3 border-b border-gray-200 flex justify-between items-center rounded-t-xl sm:rounded-t-lg">
              <h3 className="text-sm sm:text-base font-bold text-red-800">Filter Decoration Services</h3>
              <button
