      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-4 text-center font-semibold text-gray-800 text-lg">Wedding Videography</h3>
          </div>
          ...
          <div className="flex flex-col items-center">
            <a href="/photography/drone-shoot" className="block group">
              <div className="w-44 h-44 rounded-full border-[5px] border-amber-800 overflow-hidden bg-gradient-to-br from-amber-50 to-yellow-50 shadow-xl hover:shadow-2xl transition-all duration-300 p-1">
                <div className="w-full h-full rounded-full overflow-hidden">
                  <img 
                    src="https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=400&h=400&fit=crop"
                    alt="Drone Shoot" 
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                  />
                </div>
            ...
            <h3 className="mt-4 text-center font-semibold text-gray-800 text-lg">Drone Shoot</h3>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-4 text-center font-semibold text-gray-800 text-lg">Pre Wedding Shoot</h3>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-4 text-center font-semibold text-gray-800 text-lg">Post Wedding Shoot</h3>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-4 text-center font-semibold text-gray-800 text-lg">Album Designing</h3>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-4 text-center font-semibold text-gray-800 text-lg">Live Wedding Streaming</h3>
          </div>
        </div>
      </section>
