...
const VendorProfile = () => {
  ...
  const Field = ({ label, children }) => (
    <div className="space-y-0.5">
      <h4 className="text-[10px] md:text-base font-bold text-red-800 uppercase tracking-wide">{label}</h4>
      {children}
    </div>
  );
  const Val = ({ children }) => (
    <p className="text-xs md:text-lg font-semibold text-gray-800">{children}</p>
  );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Field label="📅 Experience">
          <div className="flex items-center gap-2">
            <span className="text-3xl md:text-5xl font-bold text-red-700">
              {vendorData.basicDetails.yearsOfExperience.split(' ')[0]}
            </span>
            <span className="text-sm md:text-xl font-semibold text-amber-700">Years</span>
          </div>
        </Field>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
              <Field label="📱 Mobile Number">
                <div className="flex items-center gap-2">
                  ...
                  <a href={`tel:${vendorData.contactInfo.mobile.replace(/\s/g, '')}`} className="text-red-600 hover:text-red-800">
              ...
              <Field label="✉️ Email ID">
                <a href={`mailto:${vendorData.contactInfo.email}`} className="text-xs md:text-lg font-semibold text-red-700 hover:text-red-900 hover:underline break-all">
              ...
              <Field label="📍 Current Location">
                <p className="text-xs md:text-lg font-semibold text-gray-800 flex items-center gap-1.5 md:gap-2">
                  <svg className="w-3.5 h-3.5 md:w-5 md:h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Field label="🌐 Website">
                <a href={`https://${vendorData.contactInfo.website}`} target="_blank" rel="noopener noreferrer" className="text-xs md:text-lg font-semibold text-red-700 hover:text-red-900 hover:underline break-all">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-4 md:gap-6">
              <Field label="👥 Team Members">
                <div className="flex items-center gap-1.5 md:gap-2">
                  <span className="text-xl md:text-5xl font-bold text-red-700">{vendorData.equipmentTeam.teamMembers.split(' ')[0]}</span>
                  <span className="text-[10px] md:text-xl font-semibold text-amber-700">Members</span>
                </div>
              </Field>
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="relative bg-gradient-to-br from-amber-600 to-amber-800 p-4 md:p-6 rounded-xl shadow-lg transform hover:scale-105 transition-transform">
                ...
                <p className="text-[10px] md:text-base text-red-900 mt-0.5 md:mt-1">Complete coverage with all services</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
              {[
                ...
                <div key={i} className="bg-white p-3 md:p-5 rounded-xl border-2 border-red-300 hover:border-amber-400 transition-colors shadow-sm">
                  <div className="flex items-center gap-1.5 md:gap-2 mb-1 md:mb-2">
                    <span className="text-lg md:text-3xl">{item.emoji}</span>
                    <h4 className="text-[10px] md:text-base font-bold text-red-800 uppercase tracking-wide">{item.label}</h4>
                  </div>
                  <p className="text-base md:text-2xl font-bold text-red-700">{item.val}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <div key={i} className={`bg-gradient-to-br ${item.color} p-4 md:p-6 rounded-xl shadow-lg text-center transform hover:scale-105 transition-transform`}>
                <div className="text-2xl md:text-5xl mb-2 md:mb-3">{item.emoji}</div>
                <h4 className="text-[10px] md:text-base font-bold text-amber-200 mb-2 md:mb-3 uppercase tracking-wide">{item.label}</h4>
                <p className="text-3xl md:text-6xl font-bold text-white mb-0.5 md:mb-1">{item.val.split(' ')[0]}</p>
                <p className="text-xs md:text-lg text-amber-100 font-semibold">Days</p>
              </div>
            ))}
          </div>
        );
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <Field label="🌐 Website / Portfolio Link">
                <a href={`https://${vendorData.portfolio.website}`} target="_blank" rel="noopener noreferrer" className="text-xs md:text-lg font-semibold text-red-700 hover:text-red-900 hover:underline flex items-center gap-1.5 md:gap-2 break-all">
                  {vendorData.portfolio.website}
                  <svg className="w-3 h-3 md:w-5 md:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Field label="📱 Instagram / Facebook Page">
                <div className="space-y-1">
                  <p className="text-xs md:text-lg font-semibold text-gray-800 flex items-center gap-1.5 md:gap-2">
                    <span className="text-base md:text-xl">📷</span> {vendorData.portfolio.instagram}
                  </p>
                  <p className="text-xs md:text-lg font-semibold text-gray-800 flex items-center gap-1.5 md:gap-2">
                    <span className="text-base md:text-xl">👍</span> {vendorData.portfolio.facebook}
                  </p>
                </div>
              </Field>
            </div>
            <Field label="☁️ Google Drive / Sample Work Link">
              <a href={`https://${vendorData.portfolio.driveLink}`} target="_blank" rel="noopener noreferrer" className="text-xs md:text-lg font-semibold text-red-700 hover:text-red-900 hover:underline flex items-center gap-1.5 md:gap-2 break-all">
            ...
            <div>
              <h4 className="text-[10px] md:text-base font-bold text-red-800 mb-2 md:mb-3 uppercase tracking-wide flex items-center gap-1.5 md:gap-2">
                  ...
                  <div key={i} className="group relative rounded-lg md:rounded-xl overflow-hidden border-2 border-red-300 bg-gradient-to-br from-red-50 to-amber-50 h-24 md:h-40 flex items-center justify-center hover:border-amber-500 transition-all shadow-md hover:shadow-xl">
                    {photo ? (
                      ...
                      <div className="text-center">
                        <svg className="w-6 h-6 md:w-10 md:h-10 text-red-400 mx-auto mb-1 md:mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <p className="text-[10px] md:text-sm text-red-600 font-semibold">Sample {i + 1}</p>
                      </div>
                    )}
                  </div>
                ))}
      ...
      case 'declaration':
        return (
          <div className="bg-gradient-to-br from-red-100 via-amber-100 to-red-100 p-4 md:p-6 rounded-xl border-2 border-red-400 shadow-inner">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-4 md:mt-6 pt-4 md:pt-6 border-t-2 border-red-400">
              <Field label="✍️ Vendor Signature">
                <p className="text-base md:text-2xl font-semibold text-gray-800 italic" style={{ fontFamily: 'Georgia, serif' }}>{vendorData.declaration.signature}</p>
              </Field>
              <Field label="📅 Date">
    ...
    return sections.map((section, index) => (
      <div key={section.id} className={`${index !== sections.length - 1 ? 'mb-6 md:mb-10' : 'mb-4 md:mb-8'}`}>
        <div className="flex items-center mb-3 md:mb-5">
          <span className="text-xl md:text-3xl mr-2 md:md-3">{section.emoji}</span>
      ...
      <div className="container mx-auto px-3 md:px-4 py-3 md:py-8 max-w-7xl">
        ...
        <nav className="mb-4 md:mb-6">
          <ol className="flex items-center space-x-1.5 md:space-x-2 text-xs md:text-base">
            <li><a href="/" className="text-red-700 hover:text-red-900 font-medium">🏠 Home</a></li>
            <li className="text-gray-400">/</li>
            <li><a href="/photography" className="text-red-700 hover:text-red-900 font-medium">📸 Photography</a></li>
            <li className="text-gray-400">/</li>
        ...
        <div className="bg-white rounded-xl md:rounded-2xl shadow-2xl border-2 border-red-400 overflow-hidden mb-4 md:mb-8">
            ...
            <div className="md:hidden relative">
              ...
              <div className="flex items-start gap-3 mb-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="inline-flex items-center gap-1.5 bg-gradient-to-r from-amber-400 to-amber-600 text-red-900 px-2.5 py-0.5 mt-1 rounded-full text-[10px] font-bold shadow-lg">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-3">
                <a href={`mailto:${vendorData.contactInfo.email}`} className="flex items-center gap-1 bg-white text-red-800 hover:bg-amber-50 px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all shadow-md hover:shadow-lg no-underline">
                  <span className="text-sm">✉️</span>
                  <span>Email</span>
                </a>
                <a href={`https://${vendorData.contactInfo.website}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 bg-white text-red-800 hover:bg-amber-50 px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all shadow-md hover:shadow-lg no-underline">
                  <span className="text-sm">🌐</span>
                  <span>Web</span>
                </a>
                {!showFullDetails && (
                  <button onClick={() => setShowFullDetails(true)} className="flex items-center gap-1 bg-gradient-to-r from-amber-500 to-amber-700 text-white hover:from-amber-600 hover:to-amber-800 px-2.5 py-1.5 rounded-lg font-bold transition-all shadow-md hover:shadow-lg text-xs whitespace-nowrap">
                    <span className="text-sm">👁️</span>
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <span className="inline-flex items-center gap-1.5 bg-gradient-to-r from-amber-400 to-amber-600 text-red-900 px-3 py-1 rounded-full text-base font-bold shadow-md">
                  ...
                  <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-white mb-3">
                    {/* LOCATION with emoji */}
                    <div>
                      <p className="text-xs text-amber-300 font-bold uppercase tracking-wider mb-0.5 flex items-center gap-1">
                    ...
                    <div>
                      ...
                      <a href={`tel:${vendorData.contactInfo.mobile.replace(/\s/g, '')}`} className="text-lg font-bold text-white hover:underline flex items-center gap-1">
                        {vendorData.contactInfo.mobile}
                      </a>
                    </div>
                    {/* OWNER with emoji */}
                    ...
                    <div>
                      ...
                      <a href={`mailto:${vendorData.contactInfo.email}`} className="text-lg font-bold text-white hover:underline break-all flex items-center gap-1">
                        {vendorData.contactInfo.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <a href={`mailto:${vendorData.contactInfo.email}`} className="flex items-center gap-1.5 bg-white text-red-800 hover:bg-amber-50 px-4 py-2 rounded-lg text-base font-bold transition-all shadow-md hover:shadow-lg no-underline">
                        <span className="text-lg">✉️</span>
                        <span>Email</span>
                      </a>
                      <a href={`https://${vendorData.contactInfo.website}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 bg-white text-red-800 hover:bg-amber-50 px-4 py-2 rounded-lg text-base font-bold transition-all shadow-md hover:shadow-lg no-underline">
                        <span className="text-lg">🌐</span>
                        <span>Web</span>
                      </a>
                    </div>
                    ...
                    {!showFullDetails && (
                      <button 
                        ...
                        className="flex items-center gap-1.5 bg-gradient-to-r from-amber-500 to-amber-700 text-white hover:from-amber-600 hover:to-amber-800 px-4 py-2 rounded-lg font-bold transition-all shadow-md hover:shadow-lg text-base whitespace-nowrap"
                      >
                        <span className="text-lg">👁️</span>
                        <span>View Full Details</span>
                      </button>
            ...
            <div className="border-t-2 border-red-300">
              ...
              <div className="p-4 md:p-8">
                <div className="flex items-center mb-4 md:mb-6">
                  <span className="text-2xl md:text-4xl mr-2 md:mr-3">{sections.find((s) => s.id === activeSection)?.emoji}</span>
                  <h3 className="text-base md:text-3xl font-bold text-red-800">
                ...
                <div className="bg-gradient-to-br from-red-50 to-amber-50 p-4 md:p-8 rounded-xl border-2 border-red-300 shadow-md">
                  ...
                  {/* Navigation Buttons */}
                  <div className="mt-5 md:mt-8 pt-4 md:pt-6 border-t-2 border-red-400 flex justify-between items-center">
                    <button onClick={goToPreviousSection} disabled={activeSection === sections[0].id} className={`flex items-center gap-1.5 md:gap-2 px-3 md:px-6 py-2 md:py-3 rounded-lg font-bold transition-all text-xs md:text-lg ${
                        activeSection === sections[0].id
                          ? 'bg-gray-200 text-gray-400 cursor-not-allowed'
                          : 'bg-white text-red-700 hover:bg-red-50 border-2 border-red-400 shadow-md hover:shadow-lg'
                      }`}>
                    ...
                    <div className="text-[10px] md:text-base font-semibold text-red-800">
                      {sections.findIndex(s => s.id === activeSection) + 1} / {sections.length}
                    </div>

                    <button onClick={goToNextSection} disabled={activeSection === sections[sections.length - 1].id} className={`flex items-center gap-1.5 md:gap-2 px-3 md:px-6 py-2 md:py-3 rounded-lg font-bold transition-all text-xs md:text-lg ${
                        activeSection === sections[sections.length - 1].id
                          ? 'bg-gray-200 text-gray-400 cursor-not-allowed'
                          : 'bg-gradient-to-r from-red-700 to-red-800 text-white hover:from-red-800 hover:to-red-900 shadow-md hover:shadow-lg'
                      }`}>
                      <span>Next</span>
                      <span className="text-sm md:text-xl">➡️</span>
                    </button>
          ...
          {showFullDetails && (
            <div className="p-4 md:p-10 border-t-2 border-red-300">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 md:mb-10">
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <h2 className="text-xl md:text-4xl font-bold text-red-800">Complete Details</h2>
                </div>
                <button onClick={() => setShowFullDetails(false)} className="mt-3 md:mt-0 flex items-center gap-1.5 md:gap-2 bg-gradient-to-r from-amber-500 to-amber-700 text-white hover:from-amber-600 hover:to-amber-800 py-2 md:py-3 px-4 md:px-6 rounded-lg font-bold transition-all shadow-lg text-xs md:text-lg">
              ...
              <div className="space-y-6 md:space-y-10">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-center mb-4 md:mb-6">
                    <span className="text-2xl md:text-4xl mr-2 md:mr-3">📇</span>
                    <h3 className="text-base md:text-3xl font-bold text-red-800">Vendor Contact Details</h3>
                    <div className="ml-2 md:ml-3 flex-1 h-0.5 md:h-1 bg-gradient-to-r from-red-600 via-amber-600 to-red-600 rounded-full"></div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div className="bg-gradient-to-br from-amber-100 to-red-100 p-4 md:p-6 rounded-xl border-2 border-amber-400 shadow-lg">
                      ...
                      <div className="space-y-2 md:space-y-3">
                        <div className="flex items-center gap-2 md:gap-3">
                          ...
                          <span className="font-semibold text-gray-800 text-xs md:text-lg">{vendorData.contactInfo.mobile}</span>
                        </div>
                        <div className="flex items-center gap-2 md:gap-3">
                          <span className="text-base md:text-2xl">✉️</span>
                          <span className="font-semibold text-gray-800 text-xs md:text-lg break-all">{vendorData.contactInfo.email}</span>
                        </div>
                    ...
                    <div className="bg-gradient-to-br from-red-100 to-amber-100 p-4 md:p-6 rounded-xl border-2 border-red-400 shadow-lg">
                      ...
                      <div className="space-y-2 md:space-y-3">
                        <div className="flex items-center gap-2 md:gap-3">
                          <span className="text-base md:text-2xl">📞</span>
                          <span className="font-semibold text-gray-800 text-xs md:text-lg">{vendorData.contactInfo.alternateMobile}</span>
                        </div>
                        <div className="flex items-center gap-2 md:gap-3">
                          <span className="text-base md:text-2xl">✉️</span>
                          <span className="font-semibold text-gray-800 text-xs md:text-lg break-all">{vendorData.contactInfo.email}</span>
                ...
                <div className="bg-gradient-to-r from-red-200 via-amber-200 to-red-200 p-4 md:p-8 rounded-xl border-2 border-red-500 shadow-xl">
                  <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6">
                    ...
                    <div className="flex-1">
                      <h4 className="text-base md:text-2xl font-bold text-red-900 mb-3 md:mb-4 flex items-center gap-1.5 md:gap-2">
                        <span className="text-lg md:text-3xl">📞</span>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4">
                        <div className="flex items-center gap-2 md:gap-3">
                          <span className="text-base md:text-2xl">📱</span>
                          <span className="font-semibold text-gray-800 text-xs md:text-lg">+91 99999 88888</span>
                        </div>
                        <div className="flex items-center gap-2 md:gap-3">
                          <span className="text-base md:text-2xl">✉️</span>
                          <span className="font-semibold text-gray-800 text-xs md:text-lg break-all">support@eliteinova.com</span>
                        </div>
                        <div className="flex items-center gap-2 md:gap-3">
                          <span className="text-base md:text-2xl">🕒</span>
                          <span className="font-semibold text-gray-800 text-xs md:text-lg">Mon-Sat: 9AM-7PM</span>
                        </div>
                        <div className="flex items-start gap-2 md:gap-3 sm:col-span-2">
                          <span className="text-base md:text-2xl flex-shrink-0">📍</span>
                          <span className="font-semibold text-gray-800 text-xs md:text-lg">123 Elite Plaza, Wedding Street, Chennai - 600001</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <>
              <div className="p-4 md:p-8 bg-gradient-to-r from-amber-50 to-red-50 border-t-2 border-red-300">
                <div className="flex items-center mb-4 md:mb-6">
                  ...
                  <div className="ml-2 md:ml-3 flex-1 h-0.5 bg-gradient-to-r from-red-600 to-amber-600 rounded-full"></div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  {/* Primary Address */}
                  <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg border-2 border-amber-300 hover:border-amber-500 transition-colors">
                    <h4 className="text-sm md:text-xl font-bold text-red-800 mb-3 md:mb-4 flex items-center gap-1.5 md:gap-2">
                      <span className="text-base md:text-2xl">🏢</span>
                      Primary Vendor Address
                    </h4>
                    <div className="space-y-2 md:space-y-3">
                      ...
                      <div className="flex items-start gap-2 md:gap-3">
                        <span className="text-sm md:text-xl flex-shrink-0">📍</span>
                  ...
                  {/* Office Address */}
                  <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg border-2 border-red-300 hover:border-red-500 transition-colors">
                    <h4 className="text-sm md:text-xl font-bold text-red-800 mb-3 md:mb-4 flex items-center gap-1.5 md:gap-2">
                      <span className="text-base md:text-2xl">🏛️</span>
                      Office Address (Secondary)
                    </h4>
              ...
              <div className="p-4 md:p-8 bg-gradient-to-r from-red-200 via-amber-200 to-red-200 border-t-2 border-red-500">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm md:text-2xl font-bold text-red-900 mb-2 md:mb-3 flex items-center gap-1.5 md:gap-2">
                      <span className="text-base md:text-2xl">📞</span>
                      For Enquiry - Eliteinova
                    </h4>
